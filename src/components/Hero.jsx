    ...
    return (
        <div className="bg-purple-200 relative h-[700px]">
            <div className='max-w-7xl mx-auto flex flex-col sm:flex-row md:flex-row items-center pt-6'>
                ...
                <p className='text-[18px] font-medium mt-6 mb-8'>Explore thousands of job opportunities with all the <br /> information you need. Its your future. Come find it. Manage all <br />your job application from start to finish.</p>
                <ActionButton url={''} tittle={'Get Started'} />
            </div>
            <div className=''>
